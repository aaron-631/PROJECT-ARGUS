...
def load_runtime_config(
    ...
    for environment_name, config_key in {
        ...
        "ARGUS_RUNTIME_MAX_CONCURRENT_REQUESTS": "max_concurrent_requests",
        "ARGUS_RUNTIME_RATE_LIMIT_RPS": "rate_limit_rps",
        "ARGUS_RUNTIME_RATE_LIMIT_BURST": "rate_limit_burst",
        "ARGUS_RUNTIME_MAX_AUDIT_SHIP_TASKS": "max_audit_ship_tasks",
